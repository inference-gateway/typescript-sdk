...
export interface paths {
  ...
  '/images/generations': {
    ...
    /**
     * Create an image
     * @description Creates an image given a prompt using the OpenAI-compatible Images API.
...
export interface components {
  ...
  responses: {
    ...
    /**
     * @description The selected provider does not implement the Images API. The
     *     gateway returns this when a request is routed to a provider without
     *     Images support.
     */
    ImagesNotSupported: {
  ...
  requestBodies: {
    ...
    /**
     * @description Request payload for the Images API. Mirrors the OpenAI
...
export type SchemaImagesResponse = components['schemas']['ImagesResponse'];
...
export interface operations {
  ...
  createImage: {
    ...
    requestBody: components['requestBodies']['CreateImageRequest'];
    responses: {
      /** @description Successful response */
      200: {
        headers: {
...
export enum CreateImageRequestQuality {
  auto = 'auto',
  standard = 'standard',
  hd = 'hd',
  low = 'low',
